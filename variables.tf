...
variable "helpernode_repo" {
  ...
  default     = "https://github.com/kabhiibm/ocp4-helpernode"
...
variable "helpernode_tag" {
  ...
  default     = "a3ce62c8e79188eab5ebb00a9de06721de2fbd56"
...
variable "openshift_install_tarball" {
  type    = string
  default = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/clients/ocp/stable-4.11/openshift-install-linux.tar.gz"
}

variable "openshift_client_tarball" {
  type    = string
  default = "https://mirror.openshift.com/pub/openshift-v4/ppc64le/clients/ocp/stable-4.11/openshift-client-linux.tar.gz"
}
